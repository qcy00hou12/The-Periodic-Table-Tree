    ...
    tabFormat: {
        "MainTab": {
            content: [
                ...
                "blank",
                ['display-text', 
                function() { if (player.C.Lol >= 3 && player.C.Res == 0) return "Alright no more games, you died. It doesn't matter how, you just did. Now you'll have to restart from the beginning but hey, atleast you'll be boosted by your max levels. I'm gonna like 200 Levels on all the Jobs and Skills. Just hit the button below to start fresh, nothing broken. Muliplier formula is: log1000(Resets) + 1 + Job/Skill / 10"}],
                ['display-text', 
