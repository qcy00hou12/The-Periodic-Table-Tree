...
// data = a function returning the content (actually HTML)
	...
	Vue.component('clickable', {
		...
		<button 
			...
			v-on:click="if(!interval) clickClickable(layer, data)" :id='"clickable-" + layer + "-" + data' @mouseenter= "hover" @mousedown="start" @mouseleave="stop1" @mouseup="stop" @touchstart="start" @touchend="stop" @touchcancel="stop">
